...
// মোবাইল বটম নেভিগেশনের জন্য আইটেম কম্পোনেন্ট
    ...
    <>
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-white/80 shadow-sm backdrop-blur-md">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
          ...
          {/* --- ডেস্কটপ মেনু (হোভার সহ) --- */}
          <NavigationMenu className="hidden lg:flex">
            {" "}
            {/* <-- শুধুমাত্র 'lg' (1024px) এর বেশি স্ক্রিনে দেখাবে */}
            <NavigationMenuList>
              <NavigationMenuItem>
                <NavigationMenuLink
                  asChild
          ...
          <div className="flex items-center gap-2">
            ...
            {/* মোবাইল: হ্যামবার্গার মেনু (এর ভিতরে সার্ভিসেস আছে) */}
                ...
                <div className="flex flex-col gap-6 px-6">
                  ...
                  <nav className="flex flex-col gap-2">
                    <SheetClose asChild>
                      <Link
                        href="/"
                        className="rounded-md px-3 py-2 text-lg font-medium hover:bg-gray-100"
                      >
                        {t.home}
                      </Link>
                    </SheetClose>

                    {/* === মোবাইল ভিউতে সার্ভিসেস মেনু (ক্লিক) === */}
                    <div>
                      <button
