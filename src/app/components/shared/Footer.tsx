...
export function Footer() {
  ...
  return (
    <>
      ...
      <footer className="relative overflow-hidden border-t border-slate-200 bg-gradient-to-br from-white via-blue-50/40 to-indigo-50/50 font-sans dark:border-slate-800/70 dark:from-slate-950 dark:via-slate-950 dark:to-indigo-950/30">
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          ...
          {/* Blue glow */}
          <div className="absolute -left-40 -top-40 h-[520px] w-[520px] rounded-full bg-blue-200/30 blur-[120px] dark:bg-blue-900/10" />

          {/* Indigo glow */}
          <div className="absolute -bottom-40 -right-40 h-[500px] w-[500px] rounded-full bg-indigo-200/30 blur-[120px] dark:bg-indigo-900/10" />

          {/* Small cyan glow */}
          <div className="absolute right-[30%] top-[25%] h-40 w-40 rounded-full bg-cyan-200/20 blur-[90px] dark:bg-cyan-900/10" />
          ...
          {/* Decorative dots */}
          <div className="absolute left-[8%] top-[18%] h-1.5 w-1.5 rounded-full bg-blue-400 shadow-[0_0_16px_rgba(59,130,246,0.8)]" />

          <div className="absolute right-[12%] top-[28%] h-2 w-2 rounded-full bg-indigo-400 shadow-[0_0_18px_rgba(99,102,241,0.8)]" />

          <div className="absolute bottom-[18%] left-[45%] h-1.5 w-1.5 rounded-full bg-cyan-400 shadow-[0_0_15px_rgba(34,211,238,0.8)]" />
        </div>
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1280px] px-5 sm:px-8 lg:px-10">
          ...
          <section className="pt-10 sm:pt-14 lg:pt-16">
            ...
            <div className="relative overflow-hidden rounded-[28px] border border-blue-200/80 bg-gradient-to-br from-blue-50 via-white to-indigo-50 shadow-[0_25px_70px_-30px_rgba(37,99,235,0.35)] dark:border-blue-400/10 dark:from-blue-950/40 dark:via-slate-950/90 dark:to-indigo-950/40">

              {/* CTA glow */}
              <div className="pointer-events-none absolute -right-24 -top-24 h-72 w-72 rounded-full bg-blue-400/10 blur-[100px]" />

              <div className="pointer-events-none absolute -bottom-28 left-[35%] h-72 w-72 rounded-full bg-indigo-400/10 blur-[100px]" />

              {/* CTA content */}
              <div className="relative flex min-h-[280px] items-center justify-between gap-10 px-7 py-10 sm:px-10 lg:px-12">

                {/* Left */}
                <div className="max-w-[680px]">

                  {/* Badge */}
                  <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-blue-200 bg-white/80 px-3 py-1.5 text-[11px] font-bold text-blue-600 shadow-sm backdrop-blur dark:border-blue-400/20 dark:bg-white/[0.04] dark:text-blue-300">
                  ...
                  {/* Heading */}
                  <h2 className="max-w-[680px] text-3xl font-black leading-[1.08] tracking-tight text-slate-950 dark:text-white sm:text-4xl lg:text-[48px]">
                  ...
                  {/* Description */}
                  <p className="mt-5 max-w-[570px] text-sm font-medium leading-6 text-slate-600 dark:text-slate-400 sm:text-base">
                    {language
                  ...
                  <div className="mt-6 flex flex-wrap gap-x-5 gap-y-3">
                    ...
                    {[
                      ...
                      <div
                        key={item}
                        className="flex items-center gap-1.5 text-[11px] font-bold text-slate-600 dark:text-slate-400"
                      >
                ...
                <Link
                  href="/contact"
                  className="button-gradient group inline-flex shrink-0 items-center justify-center gap-2.5 rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 px-6 py-3.5 text-sm font-bold text-white shadow-xl shadow-blue-600/25 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-indigo-600/30 sm:px-7"
                >
                  {language
                    ? 'প্রজেক্ট শুরু করুন'
                    : 'Start a Project'}
          ...
          <div className="grid items-start gap-12 py-14 sm:py-16 lg:grid-cols-[1.65fr_0.8fr_1fr_1.45fr] lg:gap-12">
            ...
            <div className="min-w-0">
              ...
              <FooterTitle>
                {language ? 'যোগাযোগ করুন' : 'Stay Connected'}
              </FooterTitle>
