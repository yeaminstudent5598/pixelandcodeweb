// src/app/components/packages/GoldClient.tsx
'use client';
...
export function GoldClient() {
  ...
  const price = language ? '৳৪,৫০০' : '$45';

  const features: Feature[] = language
    ? [
        { icon: MessageCircle, title: '২০০-৩০০ মেসেজ কনভারসেশন', desc: 'আমরা এনশিওর করি যে আপনি রিয়েল কাস্টমারদের থেকে মেসেজ পাবেন।' },
        { icon: Clock, title: '৭ দিন অ্যাক্টিভ ক্যাম্পেইন', desc: 'আপনার বিজ্ঞাপনটি টানা ৭ দিন ফেসবুকে লাইভ থাকবে।' },
        { icon: Target, title: 'অ্যাডভান্সড অডিয়েন্স টার্গেটিং', desc: 'বয়স, লোকেশন এবং ইন্টারেস্ট অনুযায়ী সঠিক কাস্টমার টার্গেট করা হবে।' },
        { icon: PenTool, title: 'ফ্রি অ্যাড কপিরাইটিং', desc: 'সেলস বাড়ানোর জন্য আমরা আকর্ষণীয় ক্যাপশন লিখে দিব।' },
        { icon: BarChart3, title: 'ডিটেইলড রিপোর্ট', desc: 'ক্যাম্পেইন শেষে আপনি সম্পূর্ণ পারফর্মেন্স রিপোর্ট পাবেন।' },
        { icon: ShieldCheck, title: '২৪/৭ সাপোর্ট', desc: 'ক্যাম্পেইন চলাকালীন যেকোনো সমস্যায় আমাদের সাপোর্ট পাবেন।' },
      ]
    : [
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="flex-1 text-center lg:text-left space-y-6">
              ...
              <p className="text-lg text-slate-600 dark:text-slate-300 max-w-xl mx-auto lg:mx-0">
                {language
                  ? 'আপনার ব্যবসার সেলস এবং ব্র্যান্ডিং একসাথে বাড়াতে এই প্যাকেজটি সেরা।'
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center lg:justify-start items-center">
                <Button asChild size="lg" className="rounded-full bg-orange-600 hover:bg-orange-700 text-white px-8 py-6 text-lg">
                  <Link href="/payment?package=fb_gold">
            ...
            <div className="w-full max-w-md">
              <div className="relative bg-white dark:bg-slate-900 rounded-3xl p-8 shadow-2xl border-2 border-orange-500">
                ...
                <Button asChild className="w-full bg-slate-900 dark:bg-white text-white dark:text-black py-6 rounded-xl font-bold">
                  <Link href="/payment?package=fb_gold">
        ...
        <div className="container px-4 mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <div key={index} className="p-8 rounded-2xl bg-slate-50 dark:bg-black border border-slate-100 dark:border-slate-800 hover:border-orange-200 transition-all">
