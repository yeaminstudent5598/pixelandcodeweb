...
const fbPackages = {
  monthly: [
    ...
    { name: "ডায়মন্ড", price: 7500, features: ["$50 Ad Credit", "১৫ দিন ক্যাম্পেইন", "৫০-১০০ হাজার রিচ"], popular: false },
  ],
  yearly: [
    ...
    { name: "ডায়মন্ড", price: 80000, features: ["$50 Ad Credit", "১৫ দিন ক্যাম্পেইন", "৫০-১০০ হাজার রিচ"], popular: false },
  ]
};

// ওয়েবসাইট প্যাকেজের ডেটা
const webPackages = {
    monthly: [
      { name: "বেসিক", price: 15000, features: ["৫ পেইজ ওয়েবসাইট", "রেসপন্সিভ ডিজাইন", "ফ্রি ডোমেইন ও হোস্টিং"], popular: false },
      { name: "স্ট্যান্ডার্ড", price: 30000, features: ["১০ পেইজ ওয়েবসাইট", "ই-কমার্স ফাংশনালিটি", "পেমেন্ট গেটওয়ে"], popular: true },
      { name: "প্রিমিয়াম", price: 50000, features: ["আনলিমিটেড পেইজ", "কাস্টম ফিচার", "ডেডিকেটেড সাপোর্ট"], popular: false },
    ],
    yearly: [
      { name: "বেসিক", price: 150000, features: ["৫ পেইজ ওয়েবসাইট", "রেসপন্সিভ ডিজাইন", "ফ্রি ডোমেইন ও হোস্টিং"], popular: false },
      { name: "স্ট্যান্ডার্ড", price: 320000, features: ["১০ পেইজ ওয়েবসাইট", "ই-কমার্স ফাংশনালিটি", "পেমেন্ট গেটওয়ে"], popular: true },
      { name: "প্রিমিয়াম", price: 550000, features: ["আনলিমিটেড পেইজ", "কাস্টম ফিচার", "ডেডিকেটেড সাপোর্ট"], popular: false },
    ]
  };

// গ্রাফিক্স ডিজাইন প্যাকেজের ডেটা
    ...
    <main className="w-full bg-gray-50 py-20 sm:py-28">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-10 flex items-center justify-center space-x-4">
          ...
          <Label htmlFor="billing-cycle" className={cn("font-semibold", isYearly && "text-blue-600")}>বাৎসরিক (১০% ছাড়)</Label>
        </div>
