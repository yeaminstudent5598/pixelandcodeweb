...
import { ArrowRight, Check, Target, BarChart, Search, Megaphone, Mail } from "lucide-react";
...
const marketingServices = [
    {
        ...
        description: "ফেসবুক, ইন্সটাগ্রামের মতো প্ল্যাটফর্মে আপনার ব্র্যান্ডের পরিচিতি এবং এনগেজমেন্ট বৃদ্ধি করুন।",
    },
    {
        icon: <Search className="h-10 w-10 text-green-500" />,
        title: "সার্চ ইঞ্জিন অপটিমাইজেশন (SEO)",
        description: "গুগল সার্চে আপনার ওয়েবসাইটকে প্রথম পাতায় নিয়ে এসে অর্গানিক ট্র্যাফিক বৃদ্ধি করুন।",
    },
    {
        icon: <BarChart className="h-10 w-10 text-purple-500" />,
        title: "গুগল এডস",
        description: "টার্গেটেড গুগল অ্যাডের মাধ্যমে সঠিক সময়ে সঠিক কাস্টমারের কাছে আপনার পণ্য পৌঁছে দিন।",
    },
    {
        icon: <Mail className="h-10 w-10 text-red-500" />,
        title: "ইমেইল মার্কেটিং",
        description: "কার্যকরী ইমেইল ক্যাম্পেইনের মাধ্যমে আপনার পুরনো কাস্টমারদের ধরে রাখুন এবং নতুন লিড তৈরি করুন।",
    }
];
      ...
      <section className="py-20 sm:py-28">
        <div className="container mx-auto px-4">
          <div className="mb-12 text-center">
            <h2 className="text-3xl font-bold text-gray-800">আমাদের ডিজিটাল মার্কেটিং সার্ভিসসমূহ</h2>
          </div>
      ...
      <section className="bg-gray-50 py-20 sm:py-28">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2">
            <div>
              <h2 className="mb-6 text-3xl font-bold text-gray-800">কেন আমাদের বেছে নিবেন?</h2>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <Check className="h-6 w-6 flex-shrink-0 text-green-500" />
                  <div>
                    <h4 className="font-semibold">ডেটা-ড্রিভেন স্ট্র্যাটেজি</h4>
                    <p className="text-gray-600">আমরা প্রতিটি ক্যাম্পেইন অ্যানালাইসিস করে সেরা ফলাফল নিশ্চিত করি।</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="h-6 w-6 flex-shrink-0 text-green-500" />
                  <div>
                    ...
                    <p className="text-gray-600">আমাদের রয়েছে ডিজিটাল মার্কেটিং ইন্ডাস্ট্রির অভিজ্ঞ এক্সপার্ট।</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="h-6 w-6 flex-shrink-0 text-green-500" />
                  <div>
                    ...
                    <p className="text-gray-600">প্রতিটি ক্যাম্পেইনের শেষে আমরা বিস্তারিত রিপোর্ট প্রদান করি।</p>
                  </div>
                </li>
              </ul>
            </div>
